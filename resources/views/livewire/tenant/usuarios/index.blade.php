<div>
    <div class="mb-8 flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-semibold text-ink-900 dark:text-ink-50">Usuários do Estabelecimento</h1>
            <p class="mt-1 text-sm text-ink-500 dark:text-ink-400">
                Gerencie os usuários que acessam o sistema
            </p>
        </div>
        <a href="{{ route('tenant.usuarios.create') }}" 
           wire:navigate
            ...
            <table class="w-full">
                <thead class="bg-ink-50 dark:bg-ink-800 border-b border-ink-200 dark:border-ink-700">
                    <tr>
                        ...
                        <th class="text-left px-6 py-3 text-xs font-medium text-ink-500 uppercase">Função</th>
                        ...
                        <tr class="hover:bg-ink-50 dark:hover:bg-ink-800/50 transition-colors">
                            ...
                            <td class="px-6 py-4">
                                @php
                                    $roleColors = [
                                        ...
                                        'garcom' => 'bg-yellow-100 text-yellow-700',
                                ...
                                @endphp
                                <span class="inline-flex px-2 py-1 rounded text-xs font-medium {{ $roleColors[$usuario->role] ?? 'bg-gray-100 text-gray-700' }}">
                            ...
                            <td class="px-6 py-4 text-right">
                                <div class="flex items-center justify-end gap-2">
                                    <a href="{{ route('tenant.usuarios.edit', $usuario) }}" 
                                       wire:navigate

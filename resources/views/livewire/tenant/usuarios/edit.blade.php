<div>
    <div class="mb-8">
        <h1 class="text-2xl font-semibold text-ink-900 dark:text-ink-50">Editar Usuário</h1>
    ...
    <div class="max-w-2xl">
        <form wire:submit="update" class="space-y-6">
            <div class="bg-white dark:bg-ink-900 rounded-lg border border-ink-200 dark:border-ink-800 p-6 space-y-5">
                ...
                <div>
                    <label class="block text-sm font-medium text-ink-700 dark:text-ink-300 mb-1">Nova Senha (opcional)</label>
                ...
                <div>
                    <label class="block text-sm font-medium text-ink-700 dark:text-ink-300 mb-1">Confirmar Nova Senha</label>
            ...
            <div class="flex justify-end gap-3">
                ...
                <button type="submit" wire:loading.attr="disabled"
                    ...
                    <span wire:loading.remove>Atualizar Usuário</span>
